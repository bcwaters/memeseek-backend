...
export class CatalogService {
  ...
  constructor(
    ...
    private readonly prisma2: PrismaService,
  ) {
    ...
    console.log(
      'mockCatalogService loaded: ' + (this.mockCatalog === mockCatalog),
    );
  ...
  `;
    ...
    //@ts-ignore
    return tableSchema.reduce((columns, currentField) => {
      columns[currentField.column_name] = currentField.data_type;
      return columns;
    }, {});
  }
